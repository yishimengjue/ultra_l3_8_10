...
- **深度**：官方本地都有原文、判官口径对等；双判官(35b/qmax)+客观统计三方一致确认——唯一稳健短板是**中文 QA**（客观非抽取题 43.6% vs 官方 54.8%，比较题 2.0% vs 9.4%），另经人工审核验证。英文深度与官方持平（英文本地采用封板 v1-hardened 同源产出 baseline，35b=2.02/qmax=2.33；另一批非同源产出深度略低，客观非抽取题占比两批均≈50%，结论不变）。
